...
Пишет уже в конец инструкций jump на возвращение к проверке условия.

#### input_str()

Чтобы не усложнять себе задачу(нет необходимости в ином решении):

input_str раскрывается транслятором как while который посимвольно читает и сразу же выводит эти символы.
...
Введенные в коде программы строки хранятся в памяти согласно варианту и выводятся также циклом посимвольно при помощи инструкций readadr, writeadr.
...
| ФИО                        |      <алг>    | <LoС> | <code байт> | <code инстр.> | <инстр.> | <такт.> | alg | acc | neum | hw | tick | struct | stream | port | pstr | prob1 | [4]char |
|:---------------------------|:---------------:|:-----:|:-----------:|:-------------:|:--------:|:-------:|:---:|:---:|:----:|:--:|:-----:|:------:|:------:|:----:|:----:|:-----:|:----:|
